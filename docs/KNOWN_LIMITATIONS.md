...
- The prime chat deck is a fixed-pane cockpit surface, so it shows the current Brian draft plus the latest Adam membrane rather than a full scrolling transcript of every prior turn.
